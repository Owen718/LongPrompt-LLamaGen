...
class T5Embedder:
    ...
    def __init__(self, device, T5_path=None, dir_or_name='t5-v1_1-xxl', *, local_cache=False, cache_dir=None, hf_token=None, use_text_preprocessing=True,
        ...
        # _, path = dir_or_name, dir_or_name
        # if local_cache:
        ...
        # exit()
        # T5_path = "/home/yetian/Project/LlamaGen/pretrained_models/t5-ckpt"
        self.tokenizer = AutoTokenizer.from_pretrained(T5_path)
        self.model = T5EncoderModel.from_pretrained(T5_path).eval()
